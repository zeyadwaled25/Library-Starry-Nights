...
function TextsSection() {
  ...
  return (
    <div className="texts-section py-5" id="texts-section">
      <div className="container">
        <div className="heading d-flex justify-content-center align-items-center mb-5 position-relative">
          <h1 className="ms-2">أحدث النصوص</h1>
          <FileText color="#1a2a47" />
        </div>

        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
          {texts.map((text) => (
            <div key={text.id} className="col">
              <div className="text-card p-4 border rounded shadow-sm">
                ...
                <p className="text-date text-end text-muted">
                  - {text.date}
                </p>
                {/* إضافة رابط للانتقال إلى صفحة التفاصيل */}
                <Link to={`/details/${text.id}`} className="text-decoration-none view-more-link">
                  <button className="btn btn-primary w-100 mt-3">عرض التفاصيل</button>
                </Link>
              </div>
            </div>
          ))}
        ...
        <div className="text-center mt-5" onClick={(e) => {e.preventDefault()}}>
          <a href="#" className="view-more-btn">عرض المزيد من النصوص</a>
        </div>
      </div>
    </div>
  );
